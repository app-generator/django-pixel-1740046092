...
- [Free Support](https://app-generator.dev/ticket/create/?generated_repo=https://github.com/app-generator/django-pixel-1740046092) via `eMail` and `Discord`
...
```bash
$ git clone https://github.com/django-pixel-1740046092.git
$ cd django-pixel-1740046092
```
